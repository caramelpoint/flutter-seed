...
void main() {
  ...
  group('Get All', () {
    final CommonResponse<ItemModel> commonResponse =
        CommonResponse<ItemModel>.fromJson(jsonDecode(fixture('get_all_items.json')) as Map<String, dynamic>);
    final List<Item> itemList = commonResponse.data;
    test('should return an Item List when the response code is 200 (success).', () async {
      // arrange
    ...
    test('should throw a ServerException when the token is not present on the storage.', () async {
      // arrange
    ...
    test('should throw a ServerException when the request throw and exception.', () async {
      // arrange
