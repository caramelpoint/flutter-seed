import 'package:caramelseed/features/fbAuth/bloc/authentication_bloc/bloc.dart';
import 'package:caramelseed/features/fbAuth/bloc/register_bloc/bloc.dart';
import 'package:caramelseed/features/fbAuth/ui/register/register_button.dart';
...
class _RegisterFormState extends State<RegisterForm> {
      ...
      if (state.isFailure) {
        Scaffold.of(context)
          ...
          ..showSnackBar(SnackBar(
            content: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[Text('Registration Failure'), Icon(Icons.error)],
            ),
  ...
  void _onFormSubmitted() {
    _registerBloc.add(Submitted(email: _emailController.text, password: _passwordController.text));
  }
}
